...
export const en = {
  ...
  menuView: "View",
  menuSplit: "Split",
  menuMultiExec: "MultiExec",
  menuTunneling: "Tunneling",
  ...
  menuCloseAll: "Close all tabs",
  menuAddConnection: "Add connection…",
  menuMultiExecOn: "Multi-exec: on",
  menuMultiExecOff: "Multi-exec: off",
  menuStartTunnel: "Start tunneling",
  menuStopTunnel: "Stop tunneling",
  menuPreferences: "Preferences…",
  menuAbout: "About OpsPilot",
  ...
  // terminal
  selectHostToOpen: "Select a connection to open a terminal",
  searchScrollback: "Ctrl+Shift+F to search scrollback",

  // AI panel
  aiCopilot: "AI Copilot",
  newSession: "+ Session",
  aiAssistant: "Remote AI assistant",
  aiContext: "Context",
  aiTokens: "tokens",
  aiUsed: "used",
  aiMcp: "MCP",
  ...
  aiLsp: "LSP",
  aiLspDisabled: "disabled",
  aiEngine: "Engine",
  aiReady: "ready",
  aiBrowser: "browser (mock)",
  askCopilot:
  ...
  // Status bar
  statusReady: "Ready",
  statusKbd: "Ctrl+P commands",
  statusTerminals: "terminal(s)",
...
export const zh: Dict = {
  ...
  menuCloseTab: "关闭标签",
  menuCloseAll: "关闭全部标签",
  menuAddConnection: "添加连接…",
  menuMultiExecOn: "多执行: 开",
  menuMultiExecOff: "多执行: 关",
  menuStartTunnel: "启动隧道",
  menuStopTunnel: "停止隧道",
  menuPreferences: "首选项…",
  menuAbout: "关于 OpsPilot",
  quickConnect: "快速连接",
  go: "连接",
  multiExec: "多执行",
  settings: "设置",
  ...
  selectHostToOpen: "选择一个连接以打开终端",
  searchScrollback: "Ctrl+Shift+F 搜索终端历史",

  aiCopilot: "AI 助手",
  newSession: "+ 会话",
  aiAssistant: "远程 AI 助手",
  aiContext: "上下文",
  aiTokens: "tokens",
  aiUsed: "已用",
  aiMcp: "MCP",
